...
namespace ChatApp.Persistence.Migrations
{
    ...
    [Migration("20231017153256_update-Message_table")]
    partial class updateMessage_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "test-one",
                            IsActive = true,
                            MessageSend = new DateTime(2023, 10, 17, 15, 32, 56, 373, DateTimeKind.Utc).AddTicks(3736),
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.Message", b =>
                {
                    b.HasOne("ChatApp.Domain.Entities.AppUser", "Recipient")
